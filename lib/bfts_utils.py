...
def edit_bfts_config_file(config_path: str, idea_dir: str, idea_path: str, start_stage: int = 1) -> str:
    """
    ...
    Args:
        ...
        start_stage: Stage number to start from (1=initial, 2=baseline, 3=creative, 4=ablation)
