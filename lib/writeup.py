...
from lib.vlm_review import generate_vlm_img_review
...
def perform_writeup(
    ...
    try:
        ...
        from lib.icbinb_writeup import load_exp_summaries
        loaded_summaries = load_exp_summaries(base_folder)
        ...
        if not osp.exists(osp.join(latex_folder, "template.tex")):
            shutil.copytree(
                "templates/icml_latex", latex_folder, dirs_exist_ok=True
            )
